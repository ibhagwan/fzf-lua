...
|FzfLuaHeaderBind       |*BlanchedAlmond |`winopts.hl.header_bind`|Header keybind|
|FzfLuaHeaderText       |*LightCoral     |`winopts.hl.header_text`|Header text|
|FzfLuaTabTitle         |*LightSkyBlue2  |`winopts.hl.tab_title`  |Tab title (`tabs`)|
|FzfLuaTabMarker        |*BlanchedAlmond |`winopts.hl.tab_marker` |Tab marker (`tabs`)|
