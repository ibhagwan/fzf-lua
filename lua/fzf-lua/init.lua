...
local lazyloaded_modules = {
  ...
  foldmarkers = { "fzf-lua.providers.nvim", "foldmarkers" },
...
M.filetypes = require("fzf-lua.providers.nvim").foldmarkers ---@type fun(opts: fzf-lua.config.Foldmarkers.p?): thread?, string?, table?
