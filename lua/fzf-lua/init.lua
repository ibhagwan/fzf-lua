...
function M.setup_highlights(override)
  ...
  local highlights = {
    ...
    { "FzfColorsNormal",         "colors_normal",     { default = default, link = "FzfLuaNormal" } },
    { "FzfColorsCursorLine",     "colors_cursorline", { default = default, link = "FzfLuaCursorLine" } },
    { "FzfColorsMatch",          "colors_match",      { default = default, link = "Special" } },
    { "FzfColorsBorder",         "colors_border",     { default = default, link = "FzfLuaBorder" } },
    { "FzfColorsScrollbar",      "colors_scrollbar",  { default = default, link = "FzfColorsBorder" } },
    { "FzfColorsSeparator",      "colors_separator",  { default = default, link = "FzfColorsBorder" } },
    { "FzfColorsGutter",         "colors_gutter",     { default = default, link = "FzfLuaNormal" } },
    { "FzfColorsHeader",         "colors_header",     { default = default, link = "FzfLuaTitle" } },
    { "FzfColorsInfo",           "colors_info",       { default = default, link = "NonText" } },
    { "FzfColorsPointer",        "colors_pointer",    { default = default, link = "Special" } },
    { "FzfColorsMarker",         "colors_marker",     { default = default, link = "FzfColorsPointer" } },
    { "FzfColorsSpinner",        "colors_spinner",    { default = default, link = "FzfColorsPointer" } },
    { "FzfColorsPrompt",         "colors_prompt",     { default = default, link = "Special" } },
    { "FzfColorsQuery",          "colors_query",      { default = default, link = "FzfLuaNormal" } },
