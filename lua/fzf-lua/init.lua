...
do
  ...
  local lazyloaded_modules = {
    ...
    git_files = { "fzf-lua.providers.git", "files", "gfiles" },
    git_status = { "fzf-lua.providers.git", "status", "gfiles-diff" },
    ...
    oldfiles = { "fzf-lua.providers.oldfiles", "oldfiles", "history-files" },
    ...
    colorschemes = { "fzf-lua.providers.colorschemes", "colorschemes", "colors" },
    ...
    keymaps = { "fzf-lua.providers.nvim", "keymaps", "maps" },
    ...
    command_history = { "fzf-lua.providers.nvim", "command_history", "history-command" },
    search_history = { "fzf-lua.providers.nvim", "search_history", "history-search" },
